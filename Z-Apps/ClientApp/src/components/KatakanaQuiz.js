...
class KatakanaQuiz extends React.Component {
    ...
    constructor(props) {
        ...
        this.consts = {
            ...
            OBJ_LINKS: {
                "Katakana chart": "https://lingualninja.blogspot.com/2018/08/katakana-chart.html",
                "Japlish - Eat a Pee Man!?": "https://lingualninja.blogspot.com/2018/09/japlish-wasei-eigo.html",
            }
        };
    }
