                                ...
                                userIds.map(id => {
                                    ...
                                    return (
                                        <tr key={id} style={tableStyle}>
                                            <td><button onClick={() => {
                                                this.setState({ page: 2, userId: id });
                                            }}
                                                style={{ color: "black" }}
                                            >Check</button></td>
                                            <td>
                                            ...
                                            <td>{logs.reduce((log1, log2) => log1.time > log2.time ? log1 : log2).time.toString().substr(5).split(".")[0].replace("T", " ")}</td>
                                        </tr>
                                    );
                                })
                            }
