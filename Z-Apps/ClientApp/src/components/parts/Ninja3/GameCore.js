...
exports.checkTerminalPC = function () {
    // ------------------------------------------------------------
    // (PC) or (スマホ/タブレット) 判定
    // ------------------------------------------------------------
...
exports.setKeyboardEvent = function (objGame) {
    // ------------------------------------------------------------
...
//ボタン押下時処理
exports.onClickButton = function (btnType) {
    if (btnType === "left") {
        //←ボタン押下判定
        this.lButton = true;
    }
...
//ボタン押下終了時処理
exports.onMouseUp = function (btnType) {
    if (btnType === "left") {
        //←ボタン押下判定
        this.lButton = false;
    }
