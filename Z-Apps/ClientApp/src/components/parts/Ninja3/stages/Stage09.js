...
Stage.getObjs = (ninja) => {
    ...
    if (ninja.snow) {
        //雪の時
        returnObjs = Object.assign(Object.assign({}, returnObjs), StageParts.getSnows(0.15, 30, true));
        if (ninja.posX < 80) {
            //左から来た時
        ...
        //雪がやんだとき
        returnObjs = Object.assign(Object.assign({}, returnObjs), { obake2: StageParts.getEnemy(16, 65, 45, ImportImgs_1.default.Obake2, 100, 0.4, 0.4) });
    }
    return returnObjs;
};
