...
Stage.getObjs = (ninja) => {
    ...
    let returnObjs = Object.assign(Object.assign(Object.assign(Object.assign({}, StageParts.getObjOutOfScreen()), StageParts.getObjWalls()), StageParts.getObjFloor()), { leftGate: StageParts.getLeftGate(7, null, null, -9), rightGate: StageParts.getRightGate(9, -8) });
    if (ninja.snow) {
        //雪の時
        Stage.bgImg = bgImg1;
        ...
        if (ninja.posX < 80) {
            //左から来た時
            returnObjs = Object.assign(Object.assign({}, returnObjs), StageParts.getFlyingRockRight(1, 17, -17, 20, 50));
        }
    }
    else {
        //雪がやんだとき
        Stage.bgImg = bgImg2;
        returnObjs = Object.assign(Object.assign({}, returnObjs), { oni1: StageParts.getEnemy(15, 65, 61, ImportImgs_1.default.Oni, 100, 0.4, 0), oni2: StageParts.getEnemy(20, 55, 56, ImportImgs_1.default.Oni, 100, 0.35, 0), oni3: StageParts.getEnemy(13, 45, 63, ImportImgs_1.default.Oni, 100, 0.5, 0), obake2: StageParts.getEnemy(30, 65, -20, ImportImgs_1.default.Obake2, 100, 0.4, 0.4) });
    }
    return returnObjs;
};
