        ...
        if (this.props.obj.scroll) {
            ...
            if (fireContinueTime) {
                ...
                if (this.props.obj.visible) {
                    ...
                    return (React.createElement("img", { src: img_1, width: size, style: style, alt: "ninja game object" }));
                }
                else {
                    //visibleがfalse
                    return React.createElement("div", null);
                ...
                return (React.createElement("img", { src: img_2, width: size, style: style, alt: "ninja game object" }));
            }
        }
