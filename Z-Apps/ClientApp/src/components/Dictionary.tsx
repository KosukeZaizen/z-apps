...
class Dictionary extends React.Component<Props, State> {
    ...
    componentDidMount() {
        const getData = async () => {
            try {
                ...
                const { xml, wordId, snippet, translatedWord } = await response.json();
    ...
    render() {
        const { screenWidth, furigana, romaji, word, wordId, imgNumber, translatedWord, snippet, otherStories } = this.state;
            ...
            <div className="center">
                ...
                <div style={{ maxWidth: 700 }}>
                    <div className="breadcrumbs" itemScope itemType="https://schema.org/BreadcrumbList" style={{ textAlign: "left" }}>
                        ...
                        {" > "}
                        <span itemProp="itemListElement" itemScope itemType="http://schema.org/ListItem">
                            <Link to="/dictionary" itemProp="item" style={{ marginRight: "5px", marginLeft: "5px" }}>
                                <span itemProp="name">
                                    {"Japanese dictionary"}
                                </span>
                            ...
                            <CharacterComment
                                ...
                                comment={
                                    furigana &&
                                        romaji ?
                                        <p>
                                            Let's check the meaning of <span
                                                style={{
                                                    fontWeight: "bold",
                            ...
                            romaji
                                ? <>
                                    <section style={{
                                        ...
                                        <p style={{ textAlign: "left" }}>{snippet + "..."}</p>
                                        <p style={{ textAlign: "left", fontStyle: "italic" }}>If you want to know more details, please check the <a
                                    ...
                                    <section style={{
                                        ...
                                        <h2 style={styleDiv}>{"Hiragana and Kanji for " + romaji}</h2>
                                        <TableContainer component={Paper}>
                                            <Table aria-label="simple table">
                                                <TableBody>
                                                    <TableRow>
                                                        <TableCell style={tableElementStyle} align="center">Hiragana</TableCell>
                                                        <TableCell style={tableElementStyle} align="center">{furigana}</TableCell>
                                                    </TableRow>
                                                    <TableRow>
                                                        <TableCell style={tableElementStyle} align="center">Kanji</TableCell>
                                    ...
                                    <section style={{
                                        ...
                                        <h2 style={styleDiv}>{"Learn Japanese from folktales"}</h2>
                                        <div style={{padding: "20px 0"}}>
                                            <CharacterComment
                                                screenWidth={screenWidth}
                                                imgNumber={(imgNumber - 1) || 3}
                                                comment={<p>
                                                    Reading a lot of sample sentences are the best way to learn new languages!<br />
                                                    Let's learn Japanese by reading popular Japanese folktales in English, Hiragana, Kanji, and Romaji!
                                                    </p>}
                                            />
                                        </div>
                                        {
                                            otherStories && otherStories.map(s => {
                                                ...
                                                return (
                                                    <div key={s.storyId} style={{ padding: "10px", marginBottom: "10px", border: "5px double gainsboro" }}>
                                                        {
                                                            screenWidth > 500 ?
                                                                <table>
                                                                    <tbody>
