...
Stage.getObjs = (ninja) => {
    ...
    if (ninja.snow) {
        //雪の時
        returnObjs = Object.assign(Object.assign(Object.assign(Object.assign({}, returnObjs), StageParts.getSoroll("SHINO", 10, 110, 62, ImportImgs_1.default.Shino, ImportImgs_1.default.Shino, 20)), StageParts.getFrozenObj("kinoko", 10, 61, 67, ImportImgs_1.default.AkaKinoko)), StageParts.getSnows(0.1, 30));
    }
    else {
        //雪がやんだとき
        returnObjs = Object.assign(Object.assign(Object.assign({}, returnObjs), { akaKinoko: StageParts.getOnePic(10, 61, 67, ImportImgs_1.default.AkaKinoko, 10, OnTouch.toAkaKinoko) }), StageParts.getSoroll("SHINO4", 10, 110, 62, ImportImgs_1.default.Shino, ImportImgs_1.default.Shino, 20));
    }
    return returnObjs;
};
